  ...
  return (
    <div className="relative min-h-dvh overflow-hidden">
      ...
      <header className="relative z-10 flex w-full items-center justify-end gap-2 p-4 sm:p-6">
        <Link
          href="/signin"
          className="inline-flex items-center justify-center rounded-full border border-foreground/15 bg-background/70 px-4 py-2 text-sm shadow-sm backdrop-blur-sm transition hover:-translate-y-0.5 hover:bg-foreground/5"
        >
          Sign in
        </Link>
        <Link
          href="/signup"
          className="inline-flex items-center justify-center rounded-full bg-foreground px-4 py-2 text-sm text-background shadow-sm transition hover:-translate-y-0.5 hover:opacity-90"
        >
          Sign up
        </Link>
      </header>
      ...
      <main className="relative z-10 mx-auto flex min-h-[calc(100dvh-5rem)] w-full max-w-6xl items-center px-4 pb-12 sm:px-6 lg:px-8">
        <div className="grid w-full gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <section className="space-y-6">
            <div className="inline-flex items-center rounded-full border border-foreground/10 bg-background/70 px-3 py-1 text-xs font-medium text-foreground/70 shadow-sm backdrop-blur-sm">
            ...
            <div className="flex flex-wrap gap-3">
              <Link
                href="/signup"
                className="inline-flex items-center justify-center rounded-full bg-foreground px-5 py-3 text-sm font-medium text-background shadow-sm transition hover:-translate-y-0.5 hover:opacity-90"
              >
                Get started
              </Link>
              <Link
                href="/signin"
                className="inline-flex items-center justify-center rounded-full border border-foreground/15 bg-background/70 px-5 py-3 text-sm font-medium shadow-sm backdrop-blur-sm transition hover:-translate-y-0.5 hover:bg-foreground/5"
              >
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {features.map((feature) => (
                <div
                  key={feature}
                  className="rounded-2xl border border-foreground/10 bg-background/70 px-4 py-3 text-sm text-foreground/80 shadow-sm backdrop-blur-sm"
                >
                  {feature}
                </div>
              ))}
          ...
          <aside className="relative">
            <div className="absolute inset-0 -z-10 rounded-[2rem] bg-foreground/5 blur-3xl" />
            <div className="rounded-[2rem] border border-foreground/10 bg-background/80 p-5 shadow-xl backdrop-blur-md sm:p-6">
              ...
              <div className="space-y-3 pt-4 text-sm leading-6 text-foreground/80">
              ...
              <div className="mt-5 rounded-2xl bg-foreground px-4 py-4 text-background">
